  ...
  return (
    <>
      <div id="contact" className="h-[screen] max-w-[1040px] m-auto md:pl-20 p-4 py-16">
        ...
        <form  ref={form} onSubmit={sendEmail} onClick={notify} className="p-4 px-8 m-auto mt-8">
          <div className="flex flex-col rounded-xl shadow-xl shadow-gray-400">
            ...
            <button className="text-2xl text-[#001b5e] rounded-[10px] border-2 border-[#001b5e] m-2 transition-[2s] hover:bg-[#001b5e] hover:text-white md:max-w-[20%]" type="submit" value="Send" >Submit</button>
            <ToastContainer />
          </div>
        </form>
      </div>
